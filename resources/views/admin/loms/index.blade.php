                      ...
                      <div class="col-12">
                        <div class="card">
                          <div class="card-header">
                            <h4 class="card-title font-weight-bold">Lom Name</h4>
                          </div>
                          <div class="card-content collpase show">
                            <div class="card-body card-dashboard">
                              ...
                              <div class="row">
                                  ...
                                  <a name="" id="" class="btn btn-primary btn-sm ml-1 mb-1" href="{{route('lom.create')}}" role="button" style="margin-right:3px;">Add lom</a>
                                  ...
                                  <form action="{{route('exportlom')}}" method="get" enctype="multipart/form-data">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td style="width:100px;">
                                        <div class="row">
                                            <a name="" id="" class="btn btn-info btn-sm  float-left" href="{{route('lom.edit',$lom->id)}}" role="button" style="margin-right:3px;">Edit</a>
                                            <form action="{{ route('lom.destroy',$lom) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('delete')
          ...
          <div class="form-group">
            ...
            aria-hidden="true">
              <div class="modal-dialog" role="document">
                ...
                <form action="{{route('importlom')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        ...
                        <a name="" id="" class="btn btn-info
                         btn-sm" href="{{asset('uploads/templates/loms.xlsx')}}" role="button" download>Download Template</a>
                  </div>
